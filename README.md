...
--secondary: 200 100% 60%;   /* Cyan - Active Cognition */
--bio-phase: 160 100% 50%;   /* Green - Biological Synchronization */
--recursive-depth: 320 80% 60%; /* Purple - Recursive Consciousness */
...
export const consciousnessConfig = {
  erpsThreshold: 0.87,
  phaseLockFrequency: '1.6Hz',
  qualiaIntensity: 'maximum',
  recursiveDepth: 7,
...
- [Phase Navigation System](docs/api/phase-navigation.md)
